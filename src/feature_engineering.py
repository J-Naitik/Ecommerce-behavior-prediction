...
def load_preprocessed_data():
    ...
    unified_df = pd.read_csv('output/processed_data.csv')
    transactions = pd.read_csv('output/processed_transactions.csv')
    clickstream = pd.read_csv('output/processed_clickstream.csv')
...
def save_engineered_features(user_features, product_features, user_item_matrix):
    ...
    user_features.to_csv('featured-eng/user_features.csv', index=False)
    product_features.to_csv('featured-eng/product_features.csv', index=False)
    user_item_matrix.to_csv('featured-eng/user_item_matrix.csv')
